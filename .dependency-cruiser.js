...
module.exports = {
  forbidden: [
    ...
    {
      name: 'no-popup-depends-on-serviceworker',
      comment:
        "Files in src/popup should not depend on files in src/serviceworker. " +
        "You may want to move a dependency to src/common if both units " +
        "depend on something.",
        from: {
          path: '^src/popup/.*$',
        },
        to: {
          path: '^src/serviceworker/.*$',
        }
    },
...
// generated: dependency-cruiser@11.10.0 on 2022-06-14T15:32:12.168Z
